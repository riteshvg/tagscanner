(function () {
  ...
  function downloadPDF() {
    ...
    win.document.write(
      '<!DOCTYPE html><html><head><title>AI Property Report - ' + propName + '</title></head><body style="font-family:sans-serif;padding:24px;max-width:800px;">' +
      '<h1>AI Property Report: ' + propName + '</h1><p>Generated by TagScanner – ' + new Date().toLocaleString() + '</p><pre style="white-space:pre-wrap;word-wrap:break-word;">' +
