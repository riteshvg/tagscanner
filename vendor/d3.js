    ...
    arc(t, n, e, r, i, o) {
      ...
      null === this._x1
        ...
        e &&
          (l < 0 && (l = (l % Da) + Da),
          l > Fa
            ? this._append`A${e},${e},0,1,${s},${t - a},${
                n - u
              }A${e},${e},0,1,${s},${(this._x1 = c)},${(this._y1 = f)}`
            : l > Ra &&
              this._append`A${e},${e},0,${+(l >= $a)},${s},${(this._x1 =
    ...
    _clipSegment(t, n, e, r, i, o) {
      ...
      for (a && ([t, n, e, r, i, o] = [e, r, t, n, o, i]); ; ) {
        ...
        8 & f
          ...
          : 2 & f
          ? ((c = n + ((r - n) * (this.xmax - t)) / (e - t)), (u = this.xmax))
          : ((c = n + ((r - n) * (this.xmin - t)) / (e - t)), (u = this.xmin)),
          i
  ...
  var ef = {
    ...
    s: function (t, n) {
      ...
      return o === a
        ...
        : '0.' + new Array(1 - o).join('0') + Wc(t, Math.max(0, n + o - 1))[0];
    },
    ...
    (t.pack = function () {
      ...
      function i(i) {
        ...
        return (
          ...
          (i.y = e / 2),
          t
            ? i.eachBefore(xp(t)).eachAfter(wp(r, 0.5, o)).eachBefore(Mp(1))
            : i
                .eachBefore(xp(mp))
                .eachAfter(wp(np, 1, o))
